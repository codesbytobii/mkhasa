            ...
            return (
              ...
              >
                ...
                >
                  <AccordionTrigger className="flex items-center gap-2 justify-between">
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        aria-label={`Select ${addressTitle}`}
                      >
                        {isSelected && (
                  ...
                  <AccordionContent>
                    <Card className="flex flex-col gap-2 border p-3 rounded-md">
                      ...
                      <div className="mt-4 flex flex-wrap items-center gap-3">
                        <Button
                          ...
                          className={
                            isSelected
                              ...
                              : "rounded-md bg-gray-100 px-4 py-2 text-sm text-gray-800"
                          }
                        >
                          {isSelected
                            ? "Selected Address"
                        ...
                        {address.id !==
                          ...
                          <button
                            type="button"
                            className="text-sm font-medium text-app-red underline underline-offset-2"
                            onClick={() =>
                              handleDeleteClick(
                                address
                              )
